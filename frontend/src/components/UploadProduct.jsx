...
const UploadProduct = ({ onClose ,getProducts}) => {
  ...
  const handleImage = async (e) => {
    ...
    console.log(file)
    console.log("Clodinary",uploadImageClodinary)
    setProductData((prev) => {
      return {
        ...prev,
  ...
  const handleSubmit=async(e)=>{
   ...
   const productReq=await fetch(ApiRequests.uploadProducts.url,{
    method:ApiRequests.uploadProducts.method,
    credentials:"include",
    headers:{
  ...
  return (
    <div className=" fixed top-0 left-0 bg-slate-900 bg-opacity-55  p-3 flex justify-center items-center w-full h-full">
      <div className="bg-white h-full max-h-[70%] w-full max-w-2xl p-6 rounded overflow-hidden ">
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-2xl">Upload Products </h2>
          <div
        ...
        <div className="grid gap-2">
            ...
            <label htmlFor="uploadImage" required>
                  ...
                  return (
                    <div className="relative w-[100px] h-[100px]">
                      <img
                        ...
                        className="bg-slate-100 border cursor-pointer  h-full "
                      />
                      <div
          ...
          <div className="grid gap-2">
            ...
            <input
              ...
              name="productName"
              required
              placeholder="Upload Product image Field This field automatically set product name"
