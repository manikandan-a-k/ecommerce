...
const RecommendedProducts = ({ categoryName, heading }) => {
        ...
        
        {
            loading?(
                loadingList.map((product, index) => {
                    return (
                      <div key={"product"+index} className="w-full border   rounded-md min-w-[310px] md:min-w-[370px] max-w-[310px] cursor-pointer md:max-w-[370px] bg-slate-50   ">
                        <div className=" h-32 md:h-40  animate-pulse flex justify-center items-center min-w-[110px] md:min-w-[130px] bg-slate-200   md:p-1  ">
                         
                        </div>
                        <div className=" animate-pulse  p-2 md:px-3 md:py-4 w-full  flex flex-col gap-2">
                          <h2 className="text-ellipsis font-medium text-base md:text-lg p-2 bg-slate-200 rounded-full  line-clamp-1 capitalize">
                            
                          </h2>
                          <p className="uppercase p-2 bg-slate-200 rounded-full  text-[11px] md:text-[14px] text-slate-600">
                          ...
                          <div className="flex gap-2  animate-pulse items-center">
                            ...
                            <div className="flex w-full items-center p-2 bg-slate-200 rounded-full gap-1 text-[10px] md:text-[11px] ">
                              ...
                              <p className="line-through w-full bg-slate-200 rounded-full">
